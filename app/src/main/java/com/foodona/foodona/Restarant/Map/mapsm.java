...
*/
/*
public class mapsm extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnCameraIdleListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, GoogleMap.OnMarkerDragListener, GoogleMap.OnMapLongClickListener, View.OnClickListener {
*/
public class mapsm extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ImageView back;
...
Button savelocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_id = AppPreferences.getSavedUser(mapsm.this).getId();
    ...
    private void configureCameraIdle() {
        onCameraIdleListener = new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                Geocoder geocoder = new Geocoder(mapsm.this);
    ...
    public void onClick(View view) {
        if (view==savelocation){
            ...
            Intent i = new Intent(mapsm.this, RestaurentCart.class);
    ...
    public void onApiFailure(Call<UserAddAddress> call, Throwable t) {
        ...
        if ((t instanceof ApiClient.NoConnectivityException))
            Toast.makeText(mapsm.this, "No internet connection", Toast.LENGTH_SHORT).show();
        else
            Toast.makeText(mapsm.this, "Please try later", Toast.LENGTH_SHORT).show();
    }
}
