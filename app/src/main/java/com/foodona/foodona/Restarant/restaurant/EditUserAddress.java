...
public class EditUserAddress extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ImageView back;
    //Our Map
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragmentedituser_address);
        ...
        user_id = AppPreferences.getSavedUser(EditUserAddress.this).getId();
    ...
    private void configureCameraIdle() {
        onCameraIdleListener = new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                Geocoder geocoder = new Geocoder(EditUserAddress.this);
    ...
    public void onClick(View view) {
        if (view == savelocation) {
            ...
            args.putString("Str_Location",Str_All_Address);
        ...
        //    Intent i = new Intent(EditUserAddress.this, RestaurentCart.class);
    ...
    public void onApiFailure(Call<UserAddAddress> call, Throwable t) {
        ...
        if ((t instanceof ApiClient.NoConnectivityException))
            Toast.makeText(EditUserAddress.this, "No internet connection", Toast.LENGTH_SHORT).show();
        else
            Toast.makeText(EditUserAddress.this, "Please try later", Toast.LENGTH_SHORT).show();
    }
}